...
<nav class="navbar navbar-expand-lg">
  <div class="container">
    <a class="navbar-brand" href="#"><i class="fas fa-store me-2"></i>UMKM Store</a>
...
<div id="heroCarousel" class="carousel slide" data-bs-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="img/loohd.png" class="d-block w-100" alt="Produk UMKM 1">
    ...
    <div class="carousel-item">
      <img src="img/hero-bg2.jpg" class="d-block w-100" alt="Produk UMKM 2">
      <div class="carousel-caption">
    ...
    <div class="carousel-item">
      <img src="img/hero-bg3.jpg" class="d-block w-100" alt="Produk UMKM 3">
      <div class="carousel-caption">
    ...
    <?php if(mysqli_num_rows($result) > 0): ?>
      ...
      <div class="col">
        <div class="card product-card h-100">
          <img src="img/<?= $product['foto'] ? htmlspecialchars($product['foto']) : 'no-image.png' ?>" class="product-image" alt="<?= htmlspecialchars($product['Nama_produk']) ?>">
